...
class PascalVOC(IMDB):
    ...
    def __init__(self, image_set, root_path, devkit_path):
        ...
        print("self._image_index_file = %s" % self._image_index_file)
        print("self._image_file_tmpl = %s" % self._image_file_tmpl)
        print("self._image_anno_tmpl = %s" % self._image_anno_tmpl)
        ...
        print("self._result_file_tmpl = %s" % self._result_file_tmpl)
